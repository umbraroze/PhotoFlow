...
- `See code in GitHub <https://github.com/umbraroze/PhotoFlow/tree/master/photo_importinator>`_.
- Complete rewrite in Python is underway; no official release as of yet.
- `Final "stable" PowerShell version <https://github.com/umbraroze/PhotoFlow/releases/tag/photoflow-powershell-final>`_
...
(The `history section <history.html>`_ has a whole lot more ranting.)
